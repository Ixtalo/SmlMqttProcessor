...
def mock_config_file(tmp_path) -> Path:
    ...
    config_template = (Path(__file__).parent.parent.joinpath("config.template.ini")
...
class TestMain:
    ...
    @staticmethod
    def test_main(mock_config_file, monkeypatch, caplog, capsys):   # pylint: disable=redefined-outer-name
        # prepare
